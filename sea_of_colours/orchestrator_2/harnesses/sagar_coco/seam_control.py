...
from sea_of_colours.orchestrator_2.harnesses.sagar_coco.comb_shapes import (
    comb_path as _comb_path,
)
from sea_of_colours.orchestrator_2.harnesses.sagar_coco.hazard_memory import (
