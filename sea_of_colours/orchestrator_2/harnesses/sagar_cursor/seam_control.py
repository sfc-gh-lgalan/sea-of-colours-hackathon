...
from sea_of_colours.orchestrator_2.harnesses.sagar_cursor.comb_shapes import (
    comb_path as _comb_path,
)
from sea_of_colours.orchestrator_2.harnesses.sagar_cursor.hazard_memory import (
